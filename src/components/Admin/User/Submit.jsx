...
import { getSubmitsByUserId,deleteSubmit } from '../../../services/admin/SubmitApi';
...
const Submit = () => {
  ...
  const fetchSubmits = async () => {
    try {
      const response = await getSubmitsByUserId(id, currentPage);
  ...
  return (
    <div className="container mx-auto mt-8 p-6 bg-white shadow-lg rounded-lg">
      <h1 className="text-3xl font-bold mb-6">Danh sách submit của người dùng</h1>
        ...
        <table className="min-w-full bg-white">
          <thead className="bg-gray-100">
            <tr>
              ...
              <th className="py-2 px-4 border-b text-left">Test case </th>
              <th className="py-2 px-4 border-b text-left">Điểm</th>
              <th className="py-2 px-4 border-b text-left">Time_ex</th>
