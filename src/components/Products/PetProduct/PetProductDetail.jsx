      ...
      <div className="flex flex-row">
        ...
        <div className="image w-1/2 text-center ">
          ...
          <div className="m-2 bg-slate-300 text-left rounded-lg">
            <p className="pb-2 pl-4 pt-4">Giống chó: </p>
            <p className="py-2 pl-4">Màu sắc</p>
            <p className="py-2 pl-4">Cân nặng</p>
            <p className="py-2 pl-4">Độ tuổi</p>
            <p className="py-2 pl-4">Giới tính</p>
            <p className="py-2 pl-4">Triệt sản:</p>
            <p className="py-2 pl-4">Nguồn gốc</p>
            <p className="py-2 pl-4">Tiêm phòng</p>
